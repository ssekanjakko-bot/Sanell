      ...
      <div className="bg-white shadow-sm sticky top-0 z-20">
        <div className="p-3 flex justify-between items-center border-b">
          ...
          <div className="flex gap-2 text-xs">
            <Link href="/get-app" className="border border-zinc-400 bg-zinc-500 text-white px-3 py-1.5 rounded-md text-sm">Get App</Link>
            <Link href="/tools" className="border border-zinc-400 bg-zinc-500 text-white px-3 py-1.5 rounded-md text-sm">Tools</Link>
            <Link href="/support" className="border border-zinc-400 bg-zinc-500 text-white px-3 py-1.5 rounded-md text-sm">Support</Link>
            <select className="border  border-zinc-400 bg-zinc-500 text-white px-3 py-1.5 rounded-md text-sm"><option>Uganda</option><option>Kenya</option></select>
