...
export default function WatchPage() {
  ...
  if (loading) return <div className="bg-black text-white min-h-screen p-8">Loading...</div>
  if (!movie) return <div className="bg-black text-white min-h-screen p-8">Movie not found</div>
