    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-8">
        ...
        <div className="space-y-4 text-gray-700">
          ...
          We collect: Name, Email, Phone Number, and Product details when you sign up as a seller.</p>

          <p><strong>2. How We Use Your Data</strong><br/>
          Your data is used only to manage your seller account, process listings, and contact you.</p>

          <p><strong>3. Data Security</strong><br/>
          All data is encrypted and protected. We use Firebase Authentication and Firestore with security rules.</p>
